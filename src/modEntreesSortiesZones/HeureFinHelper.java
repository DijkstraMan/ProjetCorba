...
public class HeureFinHelper
{
    ...
    public static org.omg.CORBA.TypeCode type()
    {
        if (_tc == null) {
            ...
            _tc = orb.create_alias_tc(id(),"HeureFin",orb.get_primitive_tc(org.omg.CORBA.TCKind.tk_long));
        }
        return _tc;
    }
    ...
    private final static String _id = "IDL:modEntreesSortiesZones/HeureFin:1.0";
